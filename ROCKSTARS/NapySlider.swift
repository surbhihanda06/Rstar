    ...
    open override func layoutSubviews() {
      ...
      //  sliderBackgroundView.layer.borderWidth = 1
       ...
       // backgroundView.backgroundColor = mainBackgroundColor
        ...
        separtionLevel_lbl1.frame = CGRect(x: separtionLabel1.frame.size.width, y: sliderBackgroundView.frame.size.height-5-5, width: 10, height: 10)
        ...
        separtionLevel_lbl4.frame = CGRect(x: separtionLabel4.frame.size.width, y: separtionTop-5, width: 10, height: 10)
        ...
        separtionLevel_lbl4.font = UIFont.systemFont(ofSize: 10)
         //separtionLevel_lbl4.transform = CGAffineTransform(rotationAngle: CGFloat(M_PI_2));
        ...
        separtionLevel_lbl3.frame = CGRect(x: separtionLabel4.frame.size.width, y: separtionTop-5, width: 10, height: 10)
        ...
        separtionLevel_lbl2.frame = CGRect(x: separtionLabel4.frame.size.width, y: separtionTop-5, width: 10, height: 10)
 ...
 */
      ...
      //  separtionTop = separtionTop+PartHeight
        ...
        separtionLevel_lbl5.frame = CGRect(x: separtionLabel4.frame.size.width, y: 0, width: 10, height: 10)
 ...
 */
      ...
      //  UserDefaults.standard.set(false, forKey: "IsTime_Rating")
        
        if(UserDefaults.standard.bool(forKey: "IsTime_Rating"))
        {
              NotificationCenter.default.post(name: NSNotification.Name(rawValue: "Rating"), object: nil, userInfo: nil)
            
        }
        else
        {
            
              NotificationCenter.default.post(name: NSNotification.Name(rawValue: "Rating_Sellin"), object: nil, userInfo: nil)
        
        }
        
        
     //   NotificationCenter.default.addObserver(self, selector: #selector(RateValue), name: NSNotification.Name(rawValue: "Rating_Sellin"), object: nil)
