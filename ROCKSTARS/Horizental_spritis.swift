...
@IBDesignable
open class Horizental_spritis: UIControl {
 ...
 */
    ...
    fileprivate func moveHandleToPosition(_ position:Double, animated:Bool = false) {
       ...
       //separtionLabel1.backgroundColor = UIColor.init(red: 240.0/255.0, green: 240.0/255.0, blue: 240.0/255.0, alpha: 1.0)
        ...
        if(UserDefaults.standard.bool(forKey: KSpirits_Edit))
        {
            NotificationCenter.default.post(name: NSNotification.Name(rawValue: KSpirits_Edit), object: nil, userInfo: nil)
